...
var SubMenu = function (_a) {
    ...
    var hoverEnents = context.mode !== "vertical" ? {
    ...
    return (React.createElement("li", __assign({ key: index, className: classes }, hoverEnents),
        React.createElement("div", __assign({ className: "sunmenu-title" }, clickEvents), title),
